...
func (f *filepickerCmp) addAttachmentToMessage() (tea.Model, tea.Cmd) {
	...
	f.selectedFile = ""
	return f, utils.CmdHandler(AttachmentAddedMsg{attachment})
}
...
func NewFilepickerCmp(app *app.App) FilepickerCmp {
	...
	return &filepickerCmp{cwdDetails: &baseDir, dirs: dirs, cursorChain: make(stack, 0), cwd: currentDirectory, app: app}
}
